...
## Setting only within curly-brackets

```{r}
#| collapse: true
c_sort <- function(...) {
  # set only within enclosing curly-brackets {}
...
*Within curly brackets* applies to functions.

It also applies to {testthat} blocks.
