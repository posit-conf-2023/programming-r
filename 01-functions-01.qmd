...
[^1]: **the** modified z-score is calculated differently $0.6745(x - \tilde{x})/MAD$ where $MAD$ is the median absolute deviation
...
🎬 Write a function to compute the variance
