...
Save [rodents-mass.csv](data/rodents-mass.csv) and [colour-responses 1.csv](data/colour-responses%201.csv)
...
```{r}
#| echo: false
rodents |> pivot_longer(cols = everything(),
                        names_to = "species",
                        values_to = "mass") |> 
...
```{r}
rodents <- rodents |> 
  mutate(shrew = (shrew - mean(shrew, na.rm = TRUE))/sd(shrew, na.rm = TRUE),
         mouse = (mouse - mean(mouse, na.rm = TRUE))/sd(mouse, na.rm = TRUE),
         rat = (rat - mean(rat, na.rm = TRUE))/sd(rat, na.rm = TRUE),
         guineapig = (guineapig - mean(guineapig, na.rm = TRUE))/sd(guineapig, na.rm = TRUE))
```

Copying and pasting a longish piece of code
