...
-   To [install the **`devtools`** and **`tidyverse`** packages](#packages) <!-- -   [Git] --> <!-- -   [GitHub account] --> <!-- -   [GitHub to be linked to RStudio](#check-link-between-rstudio-and-github) -->
...
## Install the **`devtools`** and **`tidyverse`** packages {#packages}
